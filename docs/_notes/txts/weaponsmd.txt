...
- **Charged Attack**: Slower but deals higher damage or has added
effects.
...
- Heavy or complex weapons that replace both main-hand and off-hand
slots.
...
These weapons are designed to counter the enemies and mechanics of each
level, providing varied gameplay rather than mirroring enemy attacks.

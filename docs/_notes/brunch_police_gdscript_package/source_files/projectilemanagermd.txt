...
Supports various types of projectiles (e.g., bullets, rockets, magic
spells).

Projectiles handle their own movement, collisions, and damage. The
system supports different types of projectiles for various weapons.
...
if (position.x < 0 || position.x > 800 || position.y < 0 || position.y >
600) {
